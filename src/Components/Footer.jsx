...
const Footer = () => {
	...
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		...
		<div className="grid lg:grid-cols-2 md:grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 ">
			...
			<div className="space-y-3">
				<div className="text-yellow-500  font-bold text-xl ">Social media</div>
	...
	<div className="py-6 text-sm text-center text-gray-400 ">© Copyright 2024. All Rights Reserved.</div>
</footer>
        </div>
    );
};
