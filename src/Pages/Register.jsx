...
const Register = () => {
	...
	<form onSubmit={handleRegister} noValidate="" action="" className="space-y-4">
		<div className="space-y-1 text-sm">
			...
			<input type="text" name="username" id="username" placeholder="Your full name" className="w-full px-4 py-3 rounded-md border-gray-700 bg-gray-900 text-gray-100 focus:border-violet-400" required/>
		</div>
		<div className="space-y-1 text-sm">
	...
	<p className="text-xs text-center sm:px-6 text-gray-950"> Do you already have an account?
		<Link to='/login' rel="noopener noreferrer" href="#" className="underline text-blue-800 font-bold"> Login  </Link>
	</p>
</div>
        </div>
    );
